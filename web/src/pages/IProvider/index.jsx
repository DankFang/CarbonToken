 ...
 * @LastEditTime: 2023-06-02 20:03:03
 */
    ...
    return (
        <>
            <div className='flex flex-col items-center justify-center w-full min-h-screen py-2 px-2  rounded-lg mt-2 mb-5 '>
                {/* 详情 */}
                <div className='w-3/4 rounded-lg h-72 mt-2 py-2'>
                    {
                        detail ? (<>
                            <div className='flex flex-row '>
                                <div className='w-1/2 rounded-lg h-64 px-2 bg-white '>
                                    ...
                                    <div className='h-44  mt-3'>
                                        <EchartsCircle remain={detail.balance} emission={detail.total_emission} />
                                    </div>
                ...
                {/* 表格 */}
                <div className='w-3/4 border border-gray-300 rounded-lg flex flex-row h-256 bg-white'>
                ...
                <div className='w-3/4 border border-gray-300 rounded-lg flex flex-row h-128 bg-white mt-5'>
                    <div className='w-full h-full'>
                        <div className='px-2'>
